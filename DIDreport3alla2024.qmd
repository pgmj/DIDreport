...
#### Förhöjd risk
```{r}
DIDline90åkAlla("Vantrivsel i skolan")
```
...
### Förhöjd risk
```{r}
DIDline90åkAlla("Psykiska/ psykosomatiska besvär")
```
### Enkätfrågor i indexet
```{r}
itemlabels.final %>% 
