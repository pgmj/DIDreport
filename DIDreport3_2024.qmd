...
fokusKommun <- "Lidingö"
jmfKommun <- factor(c(fokusKommun,"Danderyd","Täby","Stockholm"),
                   levels = c(fokusKommun,"Danderyd","Täby","Stockholm"))
...
# fokusKommun <- "Solna"
# jmfKommun <- factor(c(fokusKommun,"Sollentuna","Sundbyberg"),
#                    levels = c(fokusKommun,"Sollentuna","Sundbyberg"))

# fokusKommun <- "Upplands-Bro"
# jmfKommun <- factor(c(fokusKommun,"Upplands Väsby","Vallentuna"),
#                    levels = c(fokusKommun,"Upplands Väsby","Vallentuna"))

#  Upplands Väsby eller Vallentuna och sedan kanske Järfälla
