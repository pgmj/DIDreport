...
## for testing/dev replace rows above with these (comment out/in):Skärholmen	,Danderyd,Upplands Väsby
fokusKommun <- "Skärholmen"
...
df.risk.gender.arskurs %>% 
  filter(!is.na(Årskurs),
         Kommun == fokusKommun) %>% filter(År == "2024")
