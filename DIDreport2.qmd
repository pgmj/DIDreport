...
#### 2022
```{r}
DIDstapel(df.risk.gender, "2022") +
  facet_wrap(~Kön)
```

```{r}
DIDstapel(df.risk.gender.arskurs, "2022") +
  facet_grid(Årskurs~Kön)
```

#### 2020
```{r}
DIDstapel(df.risk.gender, "2020") +
  facet_wrap(~Kön)
```

```{r}
DIDstapel(df.risk.gender.arskurs, "2020") +
  facet_grid(Årskurs~Kön)
```

#### 2018
```{r}
DIDstapel(df.risk.gender, "2018") +
  facet_wrap(~Kön)
```

```{r}
DIDstapel(df.risk.gender.arskurs, "2018") +
  facet_grid(Årskurs~Kön)
```
#### 2016
```{r}
DIDstapel(df.risk.gender, "2016") +
  facet_wrap(~Kön)
```

```{r}
DIDstapel(df.risk.gender.arskurs, "2016") +
  facet_grid(Årskurs~Kön)
```
:::
